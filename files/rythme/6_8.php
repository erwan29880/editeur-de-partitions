...
for($g=0;$g<count($chaineArray);$g++){
	...
	if(preg_match('#1-[0-9pt]{2,3}10\s[0-9pt]{2,3}10\s[0-9pt]{2,3}40#',$chaineArray[$g])){
		$pos=40*$coefficient;
		$chaineArray[$g]=preg_replace('#(1-[0-9pt]{2,3}10\s[0-9pt]{2,3}10\s)([0-9pt]{2,3}40)#','$1$2 2-'.$pos.'L',$chaineArray[$g]);
		$trucbidule=$chaineArray[$g];
	}
	...
	$chaineArray[$g]=preg_replace('#(2-[0-9]{1,2}[\'"]{0,1}[pt]{1}40\s{1,2}[0-9]{1,2}[\'"]{0,1}[pt]{1}20)#','$1 3-80L',$chaineArray[$g]);
	$chaineArray[$g]=preg_replace('#(1-[0-9]{1,2}[\'"]{0,1}[pt]{1}20\s{1,2}[0-9]{1,2}[\'"]{0,1}[pt]{1}40)#','$1 2-40L',$chaineArray[$g]);
	$chaineArray[$g]=preg_replace('#(3-[0-9]{1,2}[\'"]{0,1}[pt]{1}20\s{1,2}[0-9]{1,2}[\'"]{0,1}[pt]{1}40)#','$1 4-40L',$chaineArray[$g]);
	$chaineArray[$g]=preg_replace('#(1-[0-9]{1,2}[\'"]{0,1}[pt]{1}40)\s{1,2}2-([0-9]{1,2}[\'"]{0,1}[pt]{1}40)\s{1,2}([0-9]{1,2}[\'"]{0,1}[pt]{1}40)#','$1 1-$2 1-$3',$chaineArray[$g]);
